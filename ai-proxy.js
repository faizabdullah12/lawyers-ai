...
export default async function handler(req, res) {
    ...
    try {
        const { messages, temperature = 0.85, max_tokens = 3000 } = req.body;
        ...
        for (const model of GROQ_MODELS) {
            try {
                ...
                // Return dalam format OpenAI-compatible (sama seperti OpenRouter)
                // sehingga kode frontend tidak perlu diubah sama sekali
